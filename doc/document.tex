...
\begin{code}
    \command{begin}{Environment} 
        Environment content
    \command{end}{Environment}
\end{code}
\begin{itemize}
...
\begin{code}
    \command{define}{marie}{cool}
    \command{title}{My Website}
    \command{begin}{document}
        \command{section}{Chapter One}
        \command{subsection}{Whoarewe}
        \command{begin}{paragraph}
            \command{textbf}{Marie Curie!} \command{newline}
            \command{textit}{An association for students of Physics!}
        \command{end}{paragraph}
        \command{subsubsection}{Code!}
            \command{begin}{code}
                    We love tabs in code!
            \command{end}{code}       
        \command{ref}{NotDefinedLabel}
